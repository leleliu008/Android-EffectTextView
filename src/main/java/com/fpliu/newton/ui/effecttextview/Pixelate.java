...
final class Pixelate implements IEffect {

    public final static int SCALE = 8;

    private float progress = 0;
    private Paint paint, oldPaint;
    private float charTime = 2000;
    private int mostCount = 20;
    private EffectTextView mHTextView;
    ...
    public void init(EffectTextView hTextView, AttributeSet attrs, int defStyle) {
