...
final class Line extends AbstractEffect {

    private float progress = 0;

    private Paint linePaint;
    private float padding; // distance between text and line
    private float gap;
    ...
    protected void initVariables() {
        xLineWidth = UIUtil.dp2px(mHTextView.getContext(), 1.5f);
        padding = UIUtil.dp2px(mHTextView.getContext(), 15);
    ...
    protected void animateStart(CharSequence text) {
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(0, 1).setDuration((long) 800);
